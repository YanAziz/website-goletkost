...
const AllPropertiesKostUHB = ({ properties }: Properties) => {
  const filteredProperties = properties.filter((kost) =>
    kost.area.includes("uhb")
  );
  return (
    <div className="pt-4">
      <p className="text-lg font-semibold">Daftar kost area UHB</p>
      <div
...
export default AllPropertiesKostUHB;
