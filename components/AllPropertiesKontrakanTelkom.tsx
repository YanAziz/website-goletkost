...
const AllPropertiesKontrakanTelkom = ({ properties }: Properties) => {
  const filteredProperties = properties.filter((kontrakan) =>
    kontrakan.area.includes("telkom")
  );
  return (
    <div className="pt-4">
      <p className="text-lg font-semibold">Daftar kontrakan area Telkom</p>
      <div
...
export default AllPropertiesKontrakanTelkom;
