...
const ProductCardKontrakan = ({
  ...
  property: PropertyKontrakanProps;
}) => {
  return (
    <Link href={`/kontrakan/${property.id}`}>
      <div className="border bg-white rounded-lg shadow-lg pb-2">
        ...
        <div className="flex pb-2 pt-3 gap-x-2 px-2">
          ...
          <div className="flex items-center gap-x-1 text-xs pr-2 font-[500]">
