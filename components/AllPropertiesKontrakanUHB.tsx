...
const AllPropertiesKontrakanUHB = ({ properties }: Properties) => {
  const filteredProperties = properties.filter((kontrakan) =>
    kontrakan.area.includes("uhb")
  );
  return (
    <div className="pt-4">
      <p className="text-lg font-semibold">Daftar kontrakan area UHB</p>
      <div
...
export default AllPropertiesKontrakanUHB;
