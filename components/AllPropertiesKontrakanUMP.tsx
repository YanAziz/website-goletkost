...
const AllPropertiesKontrakanUMP = ({ properties }: Properties) => {
  const filteredProperties = properties.filter((kontrakan) =>
    kontrakan.area.includes("ump")
  );
  return (
    <div className="pt-4">
      <p className="text-lg font-semibold">Daftar kontrakan area UMP</p>
      <div
...
export default AllPropertiesKontrakanUMP;
