...
const AllPropertiesKostUnsoed = ({ properties }: Properties) => {
  const filteredProperties = properties.filter((kost) =>
    kost.area.includes("unsoed")
  );
  return (
    <div className="pt-4">
      <p className="text-lg font-semibold">Daftar kost area Unsoed</p>
      <div
...
export default AllPropertiesKostUnsoed;
